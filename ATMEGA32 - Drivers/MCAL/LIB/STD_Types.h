...
typedef signed char int8_t;             /*Define Type of 1  signed Byte*/
typedef unsigned int uint16_t;           /*Define Type of 2  Unsigned Byte*/
typedef signed short int int16_t;       /*Define Type of 2  signed Byte*/
typedef unsigned long int uint32_t;      /*Define Type of 4  Unsigned Byte*/
typedef signed long int int32_t;        /*Define Type of 4  signed Byte*/
typedef unsigned long long int uint64_t; /*Define Type of 8  Unsigned Byte*/
typedef signed long long int int64_t;   /*Define Type of 8  signed Byte*/
